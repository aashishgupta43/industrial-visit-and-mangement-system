<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Computer_science.aspx.cs" Inherits="Computer_science" %>
  ...
  <h1 align="center" style="background-color: #003366; height: 68px; width: 1286px; top: 0px; left: 0px;  font-weight: 700;
    ...
    width: 100%;"> 
     ...
     <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu"
                            ...
                            <Items>
                                <asp:MenuItem NavigateUrl="~/civil.aspx" Text="Back" />
                              ...
                              <asp:MenuItem Text="Next" Value="Contact Us" NavigateUrl="~/Electrical.aspx"></asp:MenuItem>
                            </Items>
                        </asp:Menu>
...
&nbsp &nbsp
    <div class="boxes" >
        <div class="grid_4">
            <figure>
                <div><img src="images/cs1.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3>Data Storage</h3>
        ...
        <div class="grid_4">
            <figure>
                <div><img src="images/cs2.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3>programming</h3>
                    <p>It is built across the Varahi river. Power generation takes place underground. Varahi is Karnataka's first underground powerhouse.</p>
        ...
        <div class="grid_4">
            <figure>
                <div><img src="images/cs3.jpg" alt="" height="340"></div>
                <figcaption>
