<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Electrical.aspx.cs" Inherits="Electrical" %>
  ...
  <h1 align="center" style="background-color: #003366; height: 68px; width: 1286px; top: 0px; left: 0px;  font-weight: 700;
    ...
    width: 100%;"> 
     ...
     <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu"
                            ...
                            <Items>
                                <asp:MenuItem NavigateUrl="~/Computer_science.aspx" Text="Back" />
                              ...
                              <asp:MenuItem Text="Next" Value="Contact Us" NavigateUrl="~/Mechanical.aspx"></asp:MenuItem>
                            </Items>
                        </asp:Menu>
...
&nbsp &nbsp
    <div class="boxes" >
        <div class="grid_4">
            <figure>
                <div><img src="images/e1.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3> Gas Plant</h3>
        ...
        <div class="grid_4">
            <figure>
                <div><img src="images/e2.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3>Compressed Plant</h3>
                    <p>It is built across the Varahi river. Power generation takes place underground. Varahi is Karnataka's first underground powerhouse.</p> 
        ...
        <div class="grid_4">
            <figure>
                <div><img src="images/e3.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3>Elecrtrical Plant</h3>
                    <p>It is built across the Varahi river. Power generation takes place underground. Varahi is Karnataka's first underground powerhouse.</p>
