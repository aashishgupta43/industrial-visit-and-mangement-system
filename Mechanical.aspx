...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mechanical.aspx.cs" Inherits="Mechanical" %>
  ...
  <h1 align="center" style="background-color: #003366; height: 68px; width: 1286px; top: 0px; left: 0px;  font-weight: 700;
    ...
    width: 100%;"> 
     ...
     <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu"
                            ...
                            <Items>
                                <asp:MenuItem NavigateUrl="~/Electrical.aspx" Text="Back" />
...
&nbsp &nbsp
    <div class="boxes" >
        <div class="grid_4">
            <figure>
                <div><img src="images/m1.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3>Machinery Plant</h3>
        ...
        <div class="grid_4">
            <figure>
                <div><img src="images/m2.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3> Saftet detection</h3>
                    <p>It is built across the Varahi river. Power generation takes place underground. Varahi is Karnataka's first underground powerhouse.</p> 
        ...
        <div class="grid_4">
            <figure>
                <div><img src="images/m3.jpg" alt="" height="340"></div>
                <figcaption>
                    <h3>Automobiles</h3>
                    <p>It is built across the Varahi river. Power generation takes place underground. Varahi is Karnataka's first underground powerhouse.</p>
